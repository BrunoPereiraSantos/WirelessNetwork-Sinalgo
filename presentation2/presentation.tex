...
\title[Sinalgo aula 2]{Sinalgo aula 2} % The short title appears at the bottom of every slide, the full title is only on the title page
...
%	\centering
%	\includemovie[autoplay,controls]{1\linewidth}{.65\linewidth}{videos/tcp-udp.mp4}
%\end{exampleblock}
\end{frame}
...
%	\centering
%	\includemovie[autoplay,controls]{1\linewidth}{.375\linewidth}{videos/omnet.mp4}
%\end{exampleblock}
...
%\begin{exampleblock}{Vídeo}
%	\centering
%	\includemovie[autoplay,controls]{1\linewidth}{.7\linewidth}{videos/sumo.mp4}
%\end{exampleblock}
\end{frame}
%------------------------------------------------
\subsection{TOSSIM}
